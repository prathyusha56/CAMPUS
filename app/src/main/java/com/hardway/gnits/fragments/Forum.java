 ...
 */
public class Forum extends Fragment implements ConnectivityReceiver.ConnectivityReceiverListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       View rootView = inflater.inflate(R.layout.fragment_forum, container, false);
        ...
        Button fab = (Button) rootView.findViewById(R.id.fab1);
        ...
        recyclerView = (RecyclerView) rootView.findViewById(R.id.recycler_view_forum);
    ...
    private void parseJsonFeed(JSONObject response) {
        try {
            JSONArray feedArray = response.getJSONArray("all1");
