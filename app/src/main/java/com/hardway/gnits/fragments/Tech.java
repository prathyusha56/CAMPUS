...
public class Tech extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        listView = (ListView) v.findViewById(R.id.list_fest);
    ...
    private void parseJsonFeed(JSONObject response) {
        try {
            JSONArray feedArray = response.getJSONArray("tech");
            ...
            for (int i = 0; i < feedArray.length(); i++) {
                ...
                item.setStatus(feedObj.getString("des"));

                item.setTimeStamp(feedObj.getString("ts"));
