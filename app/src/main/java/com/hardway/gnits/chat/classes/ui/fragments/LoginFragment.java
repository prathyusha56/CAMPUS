...
import com.hardway.gnits.chat.classes.core.login.LoginContract;
import com.hardway.gnits.chat.classes.core.login.LoginPresenter;
import com.hardway.gnits.chat.classes.ui.activities.RegisterActivity;
...
public class LoginFragment extends Fragment implements View.OnClickListener, LoginContract.View {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View fragmentView = inflater.inflate(R.layout.fragment_login1, container, false);
